class Chronometer {
  ...
  split() {
    ...
    let minutesString = this.computeTwoDigitNumber(this.getMinutes(this.currentTime));
    let secondsString = '';
    if (this.currentTime >= 60) {
      secondsString = this.computeTwoDigitNumber(this.getSeconds(this.currentTime));
